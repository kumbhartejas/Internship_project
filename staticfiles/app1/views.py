...
def home(request):
    ...
    abt01=abt1.objects.all()
    abt02=abt2.objects.all()
...
def abt_detail(request, model_name, slug):
    if model_name == 'abt1':
        obj = get_object_or_404(abt1, slug=slug)
    elif model_name == 'abt2':
        obj = get_object_or_404(abt2, slug=slug)
    else:
        raise Http404("Model not found.")

    return render(request, 'details2.html', {'object': obj})
